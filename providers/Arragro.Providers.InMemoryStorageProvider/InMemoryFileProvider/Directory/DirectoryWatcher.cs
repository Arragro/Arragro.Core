...
namespace Arragro.Providers.InMemoryStorageProvider.Directory
{
    ...
    internal class DirectoryWatcherFilterMatchedEventArgs<TDirectoryItemEventArgs> : EventArgs
    {
    ...
    internal class DirectoryWatcher : BaseDirectoryVisitor, IDisposable
    {
