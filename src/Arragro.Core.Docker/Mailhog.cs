    ...
    public static class Mailhog
    {
        public static async Task<ContainerListResponse> StartMailhog(DockerClient client)
        {
            ...
            var hostConfig = new HostConfig
            {
                ...
                {
                    { "8025/tcp", new List<PortBinding> { new PortBinding { HostIP = "127.0.0.1", HostPort = "5080" } } },
                    { "1025/tcp", new List<PortBinding> { new PortBinding { HostIP = "127.0.0.1", HostPort = "25" } } }
                }
            };
